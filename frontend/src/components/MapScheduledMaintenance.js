...
function MapScheduledMaintenance() {

    const [repairs, setRepairs] = useState([])
    const [openAdditional, toggleAdditional] = useState(false)
          //Redux
    ...
    return (
        <div style={{  display: 'flex', flexFlow: 'row wrap', justifyContent: 'space-around', alignItems: 'center'}}>
            <button onClick={handleClick}>Fetch Maintenance</button>
            <div>
                    {repairs.map((rep,idx) => (
...
export default MapScheduledMaintenance;